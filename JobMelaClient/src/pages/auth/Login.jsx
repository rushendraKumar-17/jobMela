...
function Login() {
  ...
  const { apiurl, login } = useContext(AuthContext);
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <button className="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
            <svg
